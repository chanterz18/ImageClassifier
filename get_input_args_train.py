...
def get_input_args_train():
    ...
    Command Line Arguments:
      7. The image directory, data_dir is defined at the front.
      1. Directory to save as --save_dir with default value, save_directory (str)
      2. CNN Model Architecture as --arch with default value 'densenet161', but could be 'vgg13' etc.
      3. Learning rate as --learning_rate with default 0.001, but could be 0.01 etc.
      4. Input to hidden layer as --hidden_units with default 512
      5. Number of epochs as --epochs and default 20
